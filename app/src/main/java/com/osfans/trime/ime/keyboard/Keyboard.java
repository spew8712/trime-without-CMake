...
public class Keyboard {
  ...
  /** 鍵盤的Shift鍵 */
  private Key mShiftKey, mCtrlKey, mAltKey, mMetaKey, mSymKey, mFunctionKey;
  ...
  public void setModiferKey(int c, Key key) {
    ...
    //    else if (c == KeyEvent.KEYCODE_FUNCTION) this.mFunctionKey = key;
  }
  ...
  */
  ...
  public boolean clikModifierKey(boolean on, int keycode) {
    ...
    //    else if (keycode == KeyEvent.META_FUNCTION_ON) {
    //      mFunctionKey.setOn(on);
    //    }
